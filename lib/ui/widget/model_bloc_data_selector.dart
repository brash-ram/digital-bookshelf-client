...
import 'package:digital_bookshelf_client/ui/widget/error_text.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';


class _ModelBlocDataSelectorState<B extends ModelBloc<S>, S, T> extends State<ModelBlocDataSelector<B, S, T>> {
  (T, Widget)? _lastBuild;
...
class ModelBlocDataSelector<B extends ModelBloc<S>, S, T> extends StatefulWidget {
  ...
  @override
  State<ModelBlocDataSelector<B, S, T>> createState() => _ModelBlocDataSelectorState<B, S, T>();
}
